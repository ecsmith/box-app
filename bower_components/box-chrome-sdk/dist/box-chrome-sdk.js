    ...
    function boxBreadCrumbs(boxItemSelected) {
        ...
        return {
            ...
            template: '<span ng-if="!!item" class="box-breadcrumb">' +
                ...
                '<span class="box-breadcrumb box-breadcrumb-parent" data-ng-click="selectFolder(parent)">{{parent.name}}</span><span class="box-breadcrumb directoryMarker">  &rang;  </span></span>' +
        ...
        return {
            ...
            link: function(scope, element) {
                if (scope.item.type === 'folder') {
                    var image = new Image();
                    image.src = chrome.runtime.getURL('img/folder.png');
                    element.empty();
